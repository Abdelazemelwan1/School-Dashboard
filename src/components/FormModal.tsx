...
const forms: {
    [key: string]: (type: "create" | "update" , dara?: any) => JSX.Element;
} = {
...
const FormModal = ({table, type,data,id} : {
  ...
  return (<>
    ...
    {open && (
        <div className=" w-[98.9vw] h-screen absolute left-0 top-0 bg-black/70 bg-opacity-60 z-50 flex items-center justify-center">
